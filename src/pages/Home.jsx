        ...
        <section className={styles.wrapper}>
            ...
            <section>
                ...
                <div>
                    ...
                    <p>
                        Over the past 9 years, I've shipped products across <strong>finance</strong>, <strong>real estate</strong>, and <strong>hospitality</strong>, 
                        working with technologies like Python, PHP (Laravel, Symfony), JavaScript (TypeScript, React, React Native, Node.js), MySQL, Docker, Redis, and Kubernetes.
                    </p>
                    <ul>
